...
## Required actions
1. Update `.superloop/tasks/racecraft-trajectory-revamp/implement/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/racecraft-trajectory-revamp/implement/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/racecraft-trajectory-revamp/` code files.
