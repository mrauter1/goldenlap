...
## Required actions
1. Update `.superloop/tasks/racecraft-trajectory-revamp/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/racecraft-trajectory-revamp/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/racecraft-trajectory-revamp/test/*` audit artifacts.
