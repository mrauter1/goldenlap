...
- Update `.superloop/tasks/racecraft-trajectory-revamp/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/racecraft-trajectory-revamp/test/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/racecraft-trajectory-revamp/test/criteria.md` (auditor-owned).
