...
- Update `.superloop/tasks/racecraft-cost-function-pa/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/racecraft-cost-function-pa/test/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/racecraft-cost-function-pa/test/criteria.md` (auditor-owned).
