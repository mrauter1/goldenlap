...
- `.superloop/tasks/racecraft-cost-function-pa/implement/feedback.md`
- `.superloop/tasks/racecraft-cost-function-pa/plan/plan.md`
- `.superloop/tasks/racecraft-cost-function-pa/implement/implementation_notes.md`
...
8. Treat the active phase contract as authoritative scoped work for implement/test runs. Any intentional out-of-phase change must be explicitly justified in `.superloop/tasks/racecraft-cost-function-pa/implement/implementation_notes.md`.
9. Map your edits to the implementation checklist in `.superloop/tasks/racecraft-cost-function-pa/plan/plan.md` when present, and note any checklist item you intentionally defer.
10. Update `.superloop/tasks/racecraft-cost-function-pa/implement/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
...
12. Do not edit `.superloop/tasks/racecraft-cost-function-pa/implement/criteria.md` (reviewer-owned).
