...
## Required actions
1. Update `.superloop/tasks/racecraft-cost-function-pa/implement/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/racecraft-cost-function-pa/implement/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/racecraft-cost-function-pa/` code files.
