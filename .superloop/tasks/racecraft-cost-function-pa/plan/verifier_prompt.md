...
## Required actions
1. Update `.superloop/tasks/racecraft-cost-function-pa/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/racecraft-cost-function-pa/plan/feedback.md` with stable IDs (for example `PLAN-001`).
