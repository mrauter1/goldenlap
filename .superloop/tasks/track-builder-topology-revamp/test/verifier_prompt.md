...
## Required actions
1. Update `.superloop/tasks/track-builder-topology-revamp/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/track-builder-topology-revamp/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/track-builder-topology-revamp/test/*` audit artifacts.
