...
## Required actions
1. Update `.superloop/tasks/track-builder-topology-revamp/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/track-builder-topology-revamp/plan/feedback.md` with stable IDs (for example `PLAN-001`).
